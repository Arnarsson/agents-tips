...
import { ariaPatterns } from "@/lib/accessibility-utils"
    ...
    return (
      <input
        ...
        className={cn(
          ...
          "bg-gradient-to-b from-white to-gray-50 text-black dark:from-background/30 dark:to-neutral-950 dark:text-white",
        ...
        >
          <input
            ...
            className={cn(
              ...
              // " dark:bg-stone-950/50 dark:text-stone-200 dark:shadow-black/10 dark:shadow-black/10 dark:placeholder:text-stone-500",
